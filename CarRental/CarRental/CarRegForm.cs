...
namespace CarRental
{
    public partial class CarRegForm : UserControl
    {
        public CarRegForm()
        {
            InitializeComponent();
        ...
        private void Init()
        {
            ...
            cmbServ.SelectedItem = cmbAvl.SelectedItem = null;
            this.LoadCarReg();
        ...
        private void LoadCarDetails(string id)
        {
            try
            {
                ...
                cmbServ.SelectedItem = dt.Rows[0]["Service"].ToString();
                cmbAvl.SelectedItem = dt.Rows[0]["Available"].ToString();
        ...
        private void NewCarReg()
        {
            ...
            txtModel.Text = "";
            txtCost.Text = "";
            cmbServ.SelectedItem = null;
            cmbAvl.SelectedItem = null;
            dataGridView1.ClearSelection();
        }
        ...
        {
            string query = "update CarReg set Service='"+cmbServ.SelectedItem+"',Model='"+txtModel.Text+"',Cost='"+txtCost.Text+"',Available='"+cmbAvl.SelectedItem+"' " +
        ...
        private void Insert()
        {
            string query = "insert into CarReg (Service,Model,Cost,Available) "+
                "values ('"+cmbServ.SelectedItem+"','"+txtModel.Text+"','"+txtCost.Text+"','"+cmbAvl.SelectedItem+"')";
